...
window.I18N = {
  zh: {
    ...
    "workshop.setup.env": "在 OpenRouter 上创建密钥，然后运行 set-key，按提示粘贴。无需编辑器，.env 中其余内容不受影响。",
    "workshop.setup.envsave": "输入过程不显示，密钥直接写入 .env，而 .env 已被 git 忽略。除了发往 OpenRouter，它不会离开你的电脑。",
    ...
    "workshop.walrus.intro": "再次运行 set-key，填入你的 Walrus 账户 ID 和委托密钥。MEMWAL_NAMESPACE 保持不变，然后用 npm run doctor 检查。",
    ...
    "evo.l2.h": "低级语言",
    "evo.l2.tradeoff": "每一个决定都在你手里，每一个细节也都要你负责。",
    "evo.l2.p": "汇编和 C 让你写得更贴近机器真正在做的事。快而精确，但内存要你自己管，没有安全网。",
    "evo.l3.h": "高级语言",
  ...
  ms: {
    ...
    "workshop.setup.env": "Cipta kunci di OpenRouter, kemudian jalankan set-key dan tampalkannya apabila diminta. Tiada editor, dan tiada apa-apa lain dalam .env berubah.",
    "workshop.setup.envsave": "Taipan anda kekal tersembunyi dan kunci ditulis terus ke .env, yang diabaikan oleh git. Ia tidak meninggalkan mesin anda kecuali untuk sampai ke OpenRouter.",
    ...
    "workshop.walrus.intro": "Jalankan set-key sekali lagi dan berikan id akaun Walrus serta kunci delegat anda. Biarkan MEMWAL_NAMESPACE seperti sedia ada, kemudian semak dengan npm run doctor.",
    ...
    "evo.l2.tradeoff": "Anda menentukan segalanya. Segalanya juga tanggungjawab anda.",
    "evo.l2.p": "Assembly dan C membolehkan anda menulis lebih hampir dengan apa yang mesin benar-benar lakukan. Pantas dan tepat, tetapi anda menguruskan memori sendiri, tanpa jaring keselamatan.",
